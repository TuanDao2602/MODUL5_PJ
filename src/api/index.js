...
import { BASE_URL_CATALOG, BASE_URL_TOPPING } from "./baseUrl"; 
...
export const getProductAPI = async (id) => {
  ...
  export const getToppingAPI = async (id) => {
    id = id || "";
    return await axios.get(`${BASE_URL_TOPPING}/${id}`);
  };
  export const addToppingAPI = async (topping) => {
    return await axios.post(BASE_URL_TOPPING, topping);
  };
  
  export const editToppingAPI = async (id, topping) => {
    console.log(id);
    return await axios.put(`${BASE_URL_TOPPING}/${id}`,topping);
  };
  
  export const deleteToppingAPI = async (id) => {
    return await axios.delete(`${BASE_URL_TOPPING}/${id}`);
  };
